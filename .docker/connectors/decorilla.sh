...
/var/www/html/protected/yiic dailypostimport --verbose=1;
...
/usr/share/logstash-7.12.0/bin/logstash -f /var/www/html/protected/config/logstash/decorilla-collection.conf --log.level=error --path.data=/home/luke/decorilla-collection$(date +%Y%m%d_%H%M%S);
/var/www/html/protected/yiic slackimportersmessage --logstashIndex=decorilla-collection;
echo "$(date) Creating Elastic Search vendors index..."
/usr/share/logstash-7.12.0/bin/logstash -f /var/www/html/protected/config/logstash/decorilla-vendors.conf --log.level=error --path.data=/home/luke/decorilla-vendors$(date +%Y%m%d_%H%M%S);
/var/www/html/protected/yiic slackimportersmessage --logstashIndex=decorilla-vendors;
echo "$(date) Creating Elastic Search colours index..."
/usr/share/logstash-7.12.0/bin/logstash -f /var/www/html/protected/config/logstash/decorilla-colours.conf --log.level=error --path.data=/home/luke/decorilla-colours$(date +%Y%m%d_%H%M%S);
/var/www/html/protected/yiic slackimportersmessage --logstashIndex=decorilla-colours;
echo "$(date) Creating Elastic Search artstyles index..."
/usr/share/logstash-7.12.0/bin/logstash -f /var/www/html/protected/config/logstash/decorilla-artstyles.conf --log.level=error --path.data=/home/luke/decorilla-artstyles$(date +%Y%m%d_%H%M%S);
/var/www/html/protected/yiic slackimportersmessage --logstashIndex=decorilla-artstyles;
echo "$(date) Creating Elastic Search brands index..."
/usr/share/logstash-7.12.0/bin/logstash -f /var/www/html/protected/config/logstash/decorilla-brands.conf --log.level=error --path.data=/home/luke/decorilla-brands$(date +%Y%m%d_%H%M%S);
